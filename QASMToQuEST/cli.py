...
_parser.add_argument('-p', '--print', nargs='?', help="Print graphical summary of circuit to file",
                     type=str)
_parser.add_argument('-e', '--entanglement', nargs='?',
                     help="Print graphical summary of entanglements to file",
                     type=str)
