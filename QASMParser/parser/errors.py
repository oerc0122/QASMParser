...
# File parsing
fileWarning = "{message} while parsing {callerType} {caller} in {file} at line {line}."
internalFileWarning = "{message} in {file} at line {line}."
...
possibleMismatchWarning = "Possible mismatch in call to {} in qarg {}. Expected {}, received {}"
...
inlineAliasLoopWarning = "Cannot loop over inline alias"
...
targetUniqueWarning = "Targets not unique in alias {}"
